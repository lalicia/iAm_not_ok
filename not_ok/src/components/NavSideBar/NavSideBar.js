  ...
  return (
    <div className="nav-bar">
        <div className="nav-list">
            <li className="nav-list-item"><a href="/writeout" className="nav-link">I'd like to get something out</a></li>
            ...
            <li className="nav-list-item"><a href="/right-now-contacts" className="nav-link">
